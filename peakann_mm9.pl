...
#### .\
#### ..\
#### data\mm9\refFlat.out
#### data\mm9\phastCons\
####                   chr1.out
####                   chr2.out
####                   ...
#### data\mm9\chromFa\     ###available at genome.ucsc
####                 chr1.fa
####                 chr2.fa
####                 ...
#### peakann_mm9.pl
...
sub hitsLookUp {
	...
	my $gene1=do { local(@ARGV, $/) = "$dir\/data\/mm9\/refFlat.out"; <>};
	$gene1=~s/\r//g;
	my @genes=split /\n/,$gene1;
	my @new_genes=();
	my %lfs=();
...
#			open(FH,"<$dir\/data\/mm9\/phastCons\/$chr_o.out") || die "PhastCons file error: $!\n";
#			$pre_chr=$chr;
#		}
...
#sub getSeq {
#	my ($chr,$start,$end)=@_;
#	open(IN1,"<$dir\/data\/mm9\/chromFa\/$chr\.fa") || die "can not open chromosome seq file\n";
